...
import { TellerFunction, GTellerExpression, FuncParseEval } from 'src/app/domains/models/math.help.model';
...
export class GTellerSettingsComponent implements OnInit {
  ...
  public seeGTellerExpression() {
    if (this.functionSettingComponent.funcFormGroup.valid) {
      const gTellerFunction: TellerFunction = GTellerExpression(this.storageService.store,
